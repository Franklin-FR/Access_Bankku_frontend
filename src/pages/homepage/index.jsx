...
//         <div>
//           <p className='absolute w-[352.67px] lg:w-[538px] h-[81.94px] lg:h-[100px] top-[142.9px] lg:top-[218px] left-[53.1px] lg:left-[142px] font-helvetica lg:font-poppins font-bold lg:font-semibold text-[31.47px] lg:text-5xl	 text-white leading-[36.18px] lg:leading-[48px] tracking-[1.5735px]'>Access to <span className='text-[#ee7e01]'> insurance</span> that’s made easy.</p>
//           <p className='absolute w-[234.68px] lg:w-[514px] h-[76px] lg:h-[99px] top-[226.16px] lg:top-[334px] left-[55.06px] lg:left-[142px] font-mulish lg:font-poppins font-semibold lg:font-normal	text-xs lg:text-lg	 leading-[19.55px] lg:leading-[32.8px] text-[#FFFFFF]'>Access Insurance Broker is a platform that matches its clients with various underwriters and also counsels them on the best insurance offers.</p>
...
//           <img src={vector} alt="" />
//         </div>
//       <div className=' flex flex-col lg:flex-row	lg:gap-8 lg:mt-[89px]'>
//         <div className='order-2 lg:order-1'>
//           <p className='font-bold font-cabin text-center lg:w-[192px] lg:h-[29px] lg:mt-2.5	 text-xs	leading-[24.54px] text-[#A5C61F]'>SECURE YOUR FUTURE</p>
//           <p className='w-[404.02px] lg:w-[469px] h-[98.99px] lg:h-[119px] mt-[14.39px] text-center font-extrabold font-mulish text-[40.11px] lg:text-5xl	 leading-[50.34px] lg:leading-[60.24]'>It's more affordable than you think</p>
//           <p className='w-[399.98px]  lg:w-[464px] h-[75px] lg:h-[87px] mt-[22.22px] font-mulish font-semibold	text-[15.04px] lg:text-[18px] leading-[24.54px] lg:leading-[29.37px] text-center text-[#5A5A5A]'>Protecting your loved ones with life insurance doesn't have to be difficult or expensive thanks to Access Insurance Brokers.</p>
//           <div className='flex justify-center mt-[16.57px]'>
//           <button className='w-[151.86px] h-[35.03px] items-center border-2 border-[#114C8D] rounded text-[#114C8D]'>Get quote</button>
//           </div>
//         </div>

//         <div className='relative mt-12 lg:mt-[0px] order-1 lg:order-2 '>
//           <div className=' absolute w-full lg:w-[607px] h-[162px] lg:h-[554px] bg-[#A5C61FCC]'></div>
//           <div className='absolute top-8 left-2 right-2 lg:w-[635px] lg:h-[563px]'>
//             <img src={family} alt=""  className='w-[402.91px]  h-[357.22px] '/>
//           </div>
//         </div>
//       </div>
